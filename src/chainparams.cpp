...
public:
    CBaseChainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("EnterTainmentCoin.co1",  "118.190.46.56"));
        vSeeds.push_back(CDNSSeedData("EnterTainmentCoin.co1",  "50.63.165.238"));
        vSeeds.push_back(CDNSSeedData("EnterTainmentCoin.co1",  "50.63.166.129"));
        vSeeds.push_back(CDNSSeedData("EnterTainmentCoin.co1",  "47.93.52.198"));
...
public:
    CMainParams() {
        ...
        assert(hashGenesisBlock == uint256("0x77ae92ef8d67f2c774c6e4236b081adfd1d4aea0a8e795037aea7b01f0abd9ab"));
        assert(genesis.hashMerkleRoot == uint256("0x46dbc383676fd567213a578a8cb2bd2f6134c339b4b74427e05efd8d0938d537"));
...
public:
    CTestNetParams() {
        ...
        assert(hashGenesisBlock == uint256("0xe687ae7f84b10cf283a23a2d4682a156ac6f81e0acaec94972a4d6c27969b0d0"));
...
public:
    CRegTestParams() {
        ...
        assert(hashGenesisBlock == uint256("0x1b7603531026f1b3c614cefba0fe0e90a5e4b493c39feb21276d3c7f6b2e0056"));
