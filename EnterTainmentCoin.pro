...
MOC_DIR = build
UI_DIR = build
RESOURCES = EnterTainmentCoin.qrc
...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.EnterTainmentCoin
    BOOST_LIB_SUFFIX=-mt
...
# also add new translations to EnterTainmentCoin.qrc under translations/
...
macx:ICON = src/qt/res/icons/EnterTainmentCoin.icns
macx:TARGET = "EnterTainmentCoin"
